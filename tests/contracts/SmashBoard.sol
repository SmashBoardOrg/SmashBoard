...
contract SmashBoard_ERC20 is Ownable {
    ...
    // Public variables for the SmashBoard ERC20 token contract
    string public constant standard = "SmashBoard ERC20";
    uint256 public constant decimals = 18;   // hardcoded to be a constant
    string public name = "SmashBoard";
...
contract SmashBoard is SmashBoard_ERC20 {
